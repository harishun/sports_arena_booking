...
$admin_email = "admin@uocsports.com";
$admin_tele = "+94771234514"; // Default email
...
<body>
    ...
    <div class="container-wrapper">
        <div class="card" style="margin-top:200px;width: 50%; max-width: 500px; text-align: left; padding: 40px;">
